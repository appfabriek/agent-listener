...
<dict>
  ...
  try {
    ...
    console.log("  Start automatisch na login.");
    console.log("  Tip: voor altijd-aan (ook zonder login): sudo agent-listener install");
  } catch (err) {
    console.error(`✗ Kon service niet laden: ${err.message}`);
    console.log(`  Plist staat op ${plistPath} — probeer handmatig:`);
...
`;
  ...
  try {
    ...
    console.error(`✗ Kon service niet activeren: ${err.message}`);
    console.log("  Probeer handmatig:");
